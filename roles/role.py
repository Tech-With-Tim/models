...
class Role(Model):
    ...
    def has_permissions(self, permissions: List[Union[int, BasePermission]]):
        ...
        return self.permissions & all_perms

    def has_permission(self, permission: Union[BasePermission, int]):
